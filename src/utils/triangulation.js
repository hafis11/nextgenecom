...
const drawPath = (points, ctx, closePath = false) => {
  try {
    ...
    region.moveTo(firstPoint.x, firstPoint.y);
    ...
    console.log("triangulation.js => function drawPath :", e.message);
  }
};

// Drawing Mesh
export const drawMesh = (faces, ctx) => {
  try {
    if (!faces || faces.length === 0) return;

    for (let i = 0; i < faces.length; i++) {
      const face = faces[i];
      if (!face || !face.keypoints) continue;
    ...
    console.log("triangulation.js => function drawMesh :", e.message);
  }
};
...
export const drawHand = (predictions, ctx) => {
  try {
    ...
    console.log("triangulation.js => function drawHand :", e.message);
  }
};
